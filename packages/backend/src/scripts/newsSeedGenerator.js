...
3. Зафіксувати baseline помилок у CI, щоб не накопичувати борг.`,
  },
  {
    ...
    body: `Платформа DevFlow (UkrOverflow) поєднує knowledge hub і community hub: питання, статті, спільноти за містами та університетами, а також профілі менторів.
